...
#: Saklama politikasının temizlediği tablolar ve zaman damgası sütunları. Aynı zamanda "büyük tablo" tanımının KAYNAĞI:
#: sınırsız büyüyebilen her tablo buraya girmek zorunda ve migration güvenlik denetimi (app/migration_sql.py,
#: tests/test_migration_safety.py) bu listeye dokunan migration'ların parçalı ve CONCURRENTLY olmasını şart koşar.
RETENTION_TARGETS = (
